 ...
 * 
 * @export
 * @interface UsersCreateTargetMessagingRequest
 */
export interface UsersCreateTargetMessagingRequest {
    /**
     ...
     * @type {string}
     * @memberof UsersCreateTargetMessagingRequest
     */
    'targetId': string;
    /**
     ...
     * @memberof UsersCreateTargetMessagingRequest
     */
    'providerType': UsersCreateTargetMessagingRequestProviderTypeEnum;
    /**
...
type UsersCreateTargetMessagingRequestProviderTypeEnum = 'email' | 'sms' | 'push'
