 ...
 * 
 * @export
 * @interface MessagingCreateTelesignProviderRequest
 */
export interface MessagingCreateTelesignProviderRequest {
    /**
     ...
     * @type {string}
     * @memberof MessagingCreateTelesignProviderRequest
     */
    'providerId': string;
    /**
     * Provider name.
