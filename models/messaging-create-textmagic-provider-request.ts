 ...
 * 
 * @export
 * @interface MessagingCreateTextmagicProviderRequest
 */
export interface MessagingCreateTextmagicProviderRequest {
    /**
     ...
     * @type {string}
     * @memberof MessagingCreateTextmagicProviderRequest
     */
    'providerId': string;
    /**
     * Provider name.
